...
import { AlertSuccess, AlertDanger} from '../Cadastro/styles';
...
export default function Cadastrar() {
    ...
    const cadUser = async e => {
      ...
      await fetch("http://localhost/logica-tcc/cadastrar_ong.php", {
        method: 'POST',
        headers: {
                ...
                <div className='container-form-cadastro'>
                    ...
                    <form onSubmit={cadUser} method="post" className='cadastro-form-input'>
                      <div className='cadastro-form-input-div'>
                          <div className='dados'>
                              <p className='input-label-cadastro'>DIGITE O NOME DA ONG</p>
                              <input type="text" name="nome" placeholder="Nome" onChange={valorInput} />
                              <br /><br />
                              <p className='input-label-cadastro'>DIGITE O EMAIL</p>
                              ...
                              <br /><br />
                              <p className='input-label-cadastro'>TELEFONE DA ONG</p>
                              <input type="text" name="telefone" placeholder="Tel" onChange={valorInput} />
                              <br /><br />
                          </div>
                          <div className='endereco'>
                              <p className='input-label-cadastro'>DIGITE O CEP</p>
                              <input 
                                  type="text"
                                  name="cep"
                                  placeholder="CEP"
