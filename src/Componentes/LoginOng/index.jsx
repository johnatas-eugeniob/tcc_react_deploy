...
import { AlertSuccess, AlertDanger, AlertWaring } from '../LoginForm/styles';
...
export default function LoginOngForm() {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const response = await fetch("http://localhost/logica-tcc/validar_ong.php", {
          method: 'POST',
          headers: {
          ...
          <div className='form-login'>
              <div className='container-form'>
                  <div className='login-title'>
                      ...
                      <p>Faça o login da sua ONG ou cadastre-se</p>
                  </div>
                  ...
                  <div className='login-form'>
                      <form onSubmit={handleSubmit} method="post">
                          <p className='input-label'>DIGITE O EMAIL DA ONG</p>
                          <input 
                              type="email"
                              name="email"
                          ...
                          <p className='input-label'>DIGITE A SENHA</p>
                          <input 
                              type="password"
                              name="senha"
